                            ...
                            <div class="mx-auto">
                                <div class="card" style="width: 37rem;">
                                    <div class="card-header position-relative py-0 border-bottom-2">
                                        ...
                                        <span class="d-flex flex-column justify-content-center">
                                            <h1 class="page-heading text-dark fw-bolder fs-2 m-0 text-center">{{$formattedAttendancePercentageSchool}}%</h1>
                ...
                <div class="py-6">
                    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                        <div class="app-toolbar-wrapper d-flex align-items-center flex-stack flex-wrap gap-2 py-4 w-100">
                            ...
                            <!--end::Page title-->
                            <a href="{{ route('dashboard.school_export',['school_id' => $school_id])}}" type="button" class="btn btn-light-success me-3">
