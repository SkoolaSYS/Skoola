						...
						<div class="row mb-6">
							...
							<div class="col-lg-8 fv-row">
								<select name="relationship" class="form-control form-control-lg form-control-solid">
									...
									<option value="Father" {{ (isset($user['relationship']) && $user['relationship'] == 'Father') ? 'selected' : '' }}>{{ __('messages.father') }}</option>
									<option value="Mother" {{ (isset($user['relationship']) && $user['relationship'] == 'Mother') ? 'selected' : '' }}>{{ __('messages.mother') }}</option>
									<option value="Guardian" {{ (isset($user['relationship']) && $user['relationship'] == 'Guardian') ? 'selected' : '' }}>{{ __('messages.guardian') }}</option>
								</select>
							</div>
							<!--end::Col-->
						</div>
